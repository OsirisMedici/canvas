...
Canvas is in preview, with no public installer or stable supported release here yet. There is no guaranteed response time, security support window, or bug bounty. A future approved release will state its support and update information.
